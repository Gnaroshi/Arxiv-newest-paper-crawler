...
- It supports lightweight triage, collections, and short personal notes; deep reading and canonical research authoring remain in Paper Lab.
...
- Backup: export a versioned private library snapshot without credentials or PDFs; restoration remains a separate provider-owned workflow.
